...
const String CRF24Message::getString() {
  char c[255];
  snprintf_P(c, 255, PSTR("CRF24Message[%u] (ID=%i, V=%0.2fV, T=%0.2fC, H=%0.2f%%, BP=%0.2fKPa, U=%0.2fsec, ERR=%i)"), pipe, 
    msg.id, msg.voltage, msg.temperature, msg.humidity, msg.baro_pressure/1000.0, (float)(msg.uptime)/1000.0, msg.error);
